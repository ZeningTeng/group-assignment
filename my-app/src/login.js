          ...
          <div className="row">
            ...
            <div className="col-lg-6 col-md-6 col-12 mb-4">
              <div className="login-container" 
                   style={{ padding: "30px", background: "white", borderRadius: "12px", boxShadow: "0 8px 24px rgba(0,0,0,0.15)" }}>
                <h3 className="text-center mb-4" style={{ color: "#333", fontWeight: 600 }}>Login</h3>
            ...
            <div className="col-lg-6 col-md-6 col-12">
              <div className="about-container" 
                   style={{ padding: "30px", background: "white", borderRadius: "12px", boxShadow: "0 8px 24px rgba(0,0,0,0.15)" }}>
                <h3 className="text-center mb-4" style={{ color: "#333", fontWeight: 600 }}>Why Choose Us?</h3>
                <div className="row">
                    ...
                    <div className="card border-0 shadow-sm h-100">
                      <div className="card-body">
                        <div className="d-flex align-items-center mb-2">
                          ...
                          <h5 className="card-title mb-0">Exquisite Craftsmanship</h5>
                        </div>
                        <p>Our jewelry pieces are crafted with precision and passion, ensuring every item is a masterpiece.</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-6 mb-3">
                    <div className="card border-0 shadow-sm h-100">
                      <div className="card-body">
                        ...
                        <p>We use only the finest materials, ensuring durability and brilliance in every piece.</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="col-md-12">
                    <div className="card border-0 shadow-sm h-100">
                      <div className="card-body text-center">
                        ...
                        <p>By shopping with us, you're supporting local artisans and contributing to the growth of our community.</p>
                      </div>
                    </div>
                  </div>
                </div>
